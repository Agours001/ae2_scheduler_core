 ...
 * ({@code data/schedulercore/recipe/scheduler_core_block.json}) or by using it on an existing crafting
 * unit block in the world (the {@code ae2:crafting_unit_transform} recipe).
 */
